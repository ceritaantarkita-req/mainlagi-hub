...
export const ENGLISH_BATCH9_WAVE_DEFINITIONS = [ENGLISH_BATCH9_WAVE_A] as const;
...
export const ENGLISH_BATCH9_WAVE_ACTIVITY_COUNTS = Object.freeze({ A: ENGLISH_BATCH9_WAVE_A.activities.length });
