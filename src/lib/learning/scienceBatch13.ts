...
import { SCIENCE_BATCH13_WAVE_D } from "./scienceBatch13WaveD";

export const SCIENCE_BATCH13_WAVES = [SCIENCE_BATCH13_WAVE_A, SCIENCE_BATCH13_WAVE_B, SCIENCE_BATCH13_WAVE_C, SCIENCE_BATCH13_WAVE_D] as const;
...
export const SCIENCE_BATCH13_WAVE_ACTIVITY_COUNTS = {
  ...
  D: SCIENCE_BATCH13_WAVE_D.activities.length
} as const;
