...
export const LETTERS_BATCH11_WAVE_DEFINITIONS = [LETTERS_BATCH11_WAVE_A] as const;
...
export const LETTERS_BATCH11_WAVE_ACTIVITY_COUNTS = Object.freeze({ A: LETTERS_BATCH11_WAVE_A.activities.length });
