...
export const IQRO_BATCH10_WAVE_DEFINITIONS = [IQRO_BATCH10_WAVE_A, IQRO_BATCH10_WAVE_B] as const;
...
export const IQRO_BATCH10_WAVE_ACTIVITY_COUNTS = Object.freeze({ A: IQRO_BATCH10_WAVE_A.activities.length, B: IQRO_BATCH10_WAVE_B.activities.length });