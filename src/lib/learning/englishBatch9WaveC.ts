...
export const ENGLISH_BATCH9_WAVE_C: EnglishBatch9WaveDefinition = {
  ...
  skills: [
    ...
    { id: "english.word.picture_matching.expanded", subjectId: "english", title: "Expanded word-picture matching", description: "Menghubungkan kata English dengan gambar yang tepat pada lebih banyak kategori.", domain: "literacy", ageMin: 4, ageMax: 7 },
  ...
  activities: [
    ...
    matching("english-picture-pair-apple-banana", "english.pack.word-picture-expanded", "english-word-picture-expanded", "Match apple and banana", "Match each word to its picture.", "english.word.picture_matching.expanded", [["apple", "APPLE", "🍎"], ["banana", "BANANA", "🍌"]], { required: true }),
    matching("english-picture-pair-run-sleep", "english.pack.word-picture-expanded", "english-word-picture-expanded", "Match run and sleep", "Connect the action words to their symbols.", "english.word.picture_matching.expanded", [["run", "RUN", "🏃"], ["sleep", "SLEEP", "😴"]]),
    matching("english-picture-pair-book-cup", "english.pack.word-picture-expanded", "english-word-picture-expanded", "Match book and cup", "Match the object words to the pictures.", "english.word.picture_matching.expanded", [["book", "BOOK", "📘"], ["cup", "CUP", "🥤"]]),
    matching("english-picture-pair-eyes-hand", "english.pack.word-picture-expanded", "english-word-picture-expanded", "Match eyes and hand", "Match the body words to their symbols.", "english.word.picture_matching.expanded", [["eyes", "EYES", "👀"], ["hand", "HAND", "✋"]], { required: true }),
    matching("english-picture-pair-mother-baby", "english.pack.word-picture-expanded", "english-word-picture-expanded", "Match mother and baby", "Match the family words to their symbols.", "english.word.picture_matching.expanded", [["mother", "MOTHER", "👩"], ["baby", "BABY", "👶"]]),
