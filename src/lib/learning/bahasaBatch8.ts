...
export const BAHASA_BATCH8_WAVE_DEFINITIONS = [BAHASA_BATCH8_WAVE_A] as const;
...
export const BAHASA_BATCH8_WAVE_ACTIVITY_COUNTS = Object.freeze({ A: BAHASA_BATCH8_WAVE_A.activities.length });
