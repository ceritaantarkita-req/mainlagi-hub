...
export const MATH_BATCH7_WAVE_DEFINITIONS = [MATH_BATCH7_WAVE_A, MATH_BATCH7_WAVE_B, MATH_BATCH7_WAVE_C] as const;
...
export const MATH_BATCH7_WAVE_ACTIVITY_COUNTS = Object.freeze({ A: MATH_BATCH7_WAVE_A.activities.length, B: MATH_BATCH7_WAVE_B.activities.length, C: MATH_BATCH7_WAVE_C.activities.length });
