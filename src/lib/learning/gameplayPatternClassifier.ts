...
export type CanonicalGameplayPattern = GameplayPattern | "spatial_relation_board" | "phrase_scene_match" | "growth_stage_transition" | "single_rule_apply" | "subitizing_glance";
