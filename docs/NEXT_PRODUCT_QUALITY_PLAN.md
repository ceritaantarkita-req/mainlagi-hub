...
| WS-02 Voice & narration | **LATENCY LIVE VERIFIED / ENGLISH QUALITY WAVE IN PR / FINAL VOICE LATER** | first-instruction latency/preload closed; PR #278 reviews all 27 English listening narrations and improves the browser English voice fallback without changing evidence; final reviewed native/pre-generated production narration remains later work |
