...
16. **NOW / PRODUCTION-APPROVAL PACKET PREPARATION FOR 14 CLEAR ASSETS + OWNER GATE FOR 3 HELD:** the internal real-source preflight is complete at 14/14 eligible assets, with exact source SHA + deterministic 512×512 alpha WebP SHA/bytes recorded in Drive tab `P0_PRODUCTION_PREFLIGHT`; public production, registry approval and runtime remain 0. Next, prepare a separate fail-closed production-approval packet for only those 14 assets, binding rights holder/license/attribution, prior visual review evidence, source SHA and preflight WebP SHA, but do not copy into `public/` or activate runtime in that packet. In parallel, keep car 499718 / towel 288034 / raincoat 212019 behind the project-owner redistribution decision gate. Do not silently adopt historical replacements 118911 / 297932 / 490914;
