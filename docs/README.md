...
Production dependency-audit recovery: [`PRODUCTION_DEPENDENCY_AUDIT_RECOVERY_2026-09-20.md`](PRODUCTION_DEPENDENCY_AUDIT_RECOVERY_2026-09-20.md) — final publication main `c023a575...` passed product gates but audit was blocked by npm registry maintenance; npm 11.19.1 exposed Bulk Advisory `503`, and recovery adds bounded transient retry without lowering the blocking high-severity threshold or changing dependency versions.  
