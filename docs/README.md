...
Production dependency-audit recovery: [`PRODUCTION_DEPENDENCY_AUDIT_RECOVERY_2026-09-20.md`](PRODUCTION_DEPENDENCY_AUDIT_RECOVERY_2026-09-20.md) — final publication main `c023a575...` hit npm Quick Audit `400 Invalid package tree` twice after all product gates passed; recovery pins npm audit client 11.19.1 without lowering the blocking high-severity threshold or changing dependency versions.  
