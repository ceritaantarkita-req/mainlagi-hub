...
Math mixed-operation runtime wave: [`WS05_MATH_MIXED_OPERATION_EXISTING_MECHANIC_REUSE_WAVE_2026-09-20.md`](WS05_MATH_MIXED_OPERATION_EXISTING_MECHANIC_REUSE_WAVE_2026-09-20.md) — active implementation hardens exact 7-ID `make_total` + 7-ID `take_away`, adds dedicated add/sub 320/390/768 QA; expected `choice_grid` 179 / 7 / 7 / 47 active.  
