...
Math mixed-operation runtime wave: [`WS05_MATH_MIXED_OPERATION_EXISTING_MECHANIC_REUSE_WAVE_2026-09-20.md`](WS05_MATH_MIXED_OPERATION_EXISTING_MECHANIC_REUSE_WAVE_2026-09-20.md) — PR #238 accepted head `33d05c52`, CI #1090 full success; exact 7+7 families, 900/900 / `choice_grid` 179 / 7 / 7 / 47 active / KEEP 900; 18-shot P0=0/P1=0; final exact-head CI required.  
...
- [`WS05_MATH_MIXED_OPERATION_EXISTING_MECHANIC_REUSE_WAVE_2026-09-20.md`](WS05_MATH_MIXED_OPERATION_EXISTING_MECHANIC_REUSE_WAVE_2026-09-20.md) — active exact four-ID runtime reuse with hardened 7+7 mechanic families and dedicated browser QA.
