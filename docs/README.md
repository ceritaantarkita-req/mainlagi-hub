...
Math mixed-operation reuse audit: [`MATH_MIXED_OPERATION_EXISTING_MECHANIC_REUSE_AUDIT_2026-09-20.md`](MATH_MIXED_OPERATION_EXISTING_MECHANIC_REUSE_AUDIT_2026-09-20.md) — fresh exact 4-ID Math audit; two direct-result additions -> existing `make_total`, two direct-result subtractions -> existing `take_away`; expected `choice_grid` 179 / 7 / 7 / 47 active; `math-mixed-choose-add` excluded; code not started.  
...
- [`MATH_MIXED_OPERATION_EXISTING_MECHANIC_REUSE_AUDIT_2026-09-20.md`](MATH_MIXED_OPERATION_EXISTING_MECHANIC_REUSE_AUDIT_2026-09-20.md) — fresh objective/evidence audit approving exact four-ID reuse of existing `make_total`/`take_away`; no Pattern #48.
