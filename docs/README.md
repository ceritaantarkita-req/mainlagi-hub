...
- [`WORLD_EVIDENCE_IMPLEMENTATION_WAVE1_2026-09-23.md`](WORLD_EVIDENCE_IMPLEMENTATION_WAVE1_2026-09-23.md) — isolated backend foundation: migration 0048 + service-role-only World supplemental-evidence RPC + disabled server route + anti-farming contracts; runtime/mastery activation remains off.
- [`WORLD_EVIDENCE_IMPLEMENTATION_WAVE2_2026-09-23.md`](WORLD_EVIDENCE_IMPLEMENTATION_WAVE2_2026-09-23.md) — source-aware mastery/progression/certificate/report isolation: World-only ceiling remains exploring, Belajar progression stays canonical-only, all activation switches remain off.
- [`WORLD_EVIDENCE_STAGE8_ACTIVATION_2026-09-23.md`](WORLD_EVIDENCE_STAGE8_ACTIVATION_2026-09-23.md) — reviewed Stage 8 subtraction activation code: assessed v2 raw observations + private DB activation registry, green CI checkpoint; PR remains unmerged and live Supabase deployment/verification is still pending.
- [`WORLD_EVIDENCE_LIVE_DB_DEPLOYMENT_2026-09-23.md`](WORLD_EVIDENCE_LIVE_DB_DEPLOYMENT_2026-09-23.md) — canonical Supabase rollout record for migrations 0047–0051, live permission/data/advisor verification, and the explicit DB-live/app-unmerged boundary.
