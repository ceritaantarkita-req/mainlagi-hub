...
Production dependency-audit recovery: [`PRODUCTION_DEPENDENCY_AUDIT_RECOVERY_2026-09-20.md`](PRODUCTION_DEPENDENCY_AUDIT_RECOVERY_2026-09-20.md) — final publication main `c023a575...` passed product gates but audit was blocked by npm registry maintenance; recovery uses npm 11.19.1 + bounded transient retry and a pinned production-only OSV fallback, without lowering security blocking semantics or changing dependency versions.  
...
- [`PRODUCTION_DEPENDENCY_AUDIT_RECOVERY_2026-09-20.md`](PRODUCTION_DEPENDENCY_AUDIT_RECOVERY_2026-09-20.md) — active recovery for #1071 npm audit endpoint compatibility; security threshold preserved, no dependency-version change.
