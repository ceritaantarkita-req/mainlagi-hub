...
- English concrete-vocabulary -> existing `picture_word_match`: audit #227 -> main `293db85d` live verified by CI #1047 exact Cloudflare smoke. Runtime PR #228 -> main `3c9b6058`; final PR CI #1053 + merged-main CI #1054 full success including exact Cloudflare production smoke; exact 23-ID fail-closed family, leak-free English presentation, 900/900 classification, 47 active, `choice_grid` 188 / `picture_word_match` 23, KEEP 900, and 9-shot P0=0/P1=0; **RUNTIME LIVE VERIFIED / CLOSURE DOCS ACTIVE**.
