...
- Math mixed-operation direct-result -> existing `make_total` / `take_away`: audit #237 -> main `c01d0bac`; runtime #238 final head `64336978` -> main `710ecdb`; final PR CI #1095 + runtime-main CI #1096 full success including exact Cloudflare smoke; exact 7+7 fail-closed families, 900/900 classification, 47 active, `choice_grid` 179 / `make_total` 7 / `take_away` 7, KEEP 900, 18-shot P0=0/P1=0; `math-mixed-choose-add` excluded; **FULLY CLOSED / LIVE VERIFIED / NO PATTERN #48**.
...
- Terminal closure: `MATH_MIXED_OPERATION_EXISTING_MECHANIC_REUSE_CLOSURE_2026-09-20.md`.
