...
- Math mixed-operation direct-result -> existing `make_total` / `take_away`: fresh exact 4-ID audit on `929a1363`; expected runtime `choice_grid` 179 / `make_total` 7 / `take_away` 7 / 47 active; `math-mixed-choose-add` excluded; **AUDIT ACTIVE / CODE NOT STARTED / NO PATTERN #48**.
