...
try {
  ...
  assert.equal(overall.choice_grid, 237, "Pattern 46 moves exactly four activities out of choice_grid");
  assert.equal(activePatterns.length, 46, "Pattern 46 raises the active child-facing pattern count to 46");
